...
import static io.vertx.redis.sentinel.RedisSentinelCommand.CKQUORUM;
import static io.vertx.redis.sentinel.RedisSentinelCommand.FAILOVER;
import static io.vertx.redis.sentinel.RedisSentinelCommand.FLUSHCONFIG;
import static io.vertx.redis.sentinel.RedisSentinelCommand.GET_MASTER_ADDR_BY_NAME;
import static io.vertx.redis.sentinel.RedisSentinelCommand.MASTER;
import static io.vertx.redis.sentinel.RedisSentinelCommand.MASTERS;
import static io.vertx.redis.sentinel.RedisSentinelCommand.RESET;
import static io.vertx.redis.sentinel.RedisSentinelCommand.SENTINELS;
import static io.vertx.redis.sentinel.RedisSentinelCommand.SLAVES;
