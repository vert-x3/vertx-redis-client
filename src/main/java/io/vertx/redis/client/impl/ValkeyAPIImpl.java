...
public class ValkeyAPIImpl implements ValkeyAPI {

  private static final Logger LOG = LoggerFactory.getLogger(ValkeyAPIImpl.class);

  private final Redis redis;
  private final RedisConnection connection;

  public ValkeyAPIImpl(RedisConnection connection) {
    this.connection = connection;
    this.redis = null;
  }

  public ValkeyAPIImpl(Redis redis) {
