...
----
compile io.vertx:vertx-redis-client:3.2.0-SNAPSHOT
----
...
If you do not do this and manually call the `link:groovydoc/io/vertx/groovy/redis/RedisClient.html#auth(java.lang.String,%20io.vertx.core.Handler)[auth]`
or `link:groovydoc/io/vertx/groovy/redis/RedisClient.html#select(int,%20io.vertx.core.Handler)[select]` then the client will not know how to recover
